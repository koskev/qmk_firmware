...
//    ├───────────┼───┼───┼───┼─────────────┼─────┤                                          ├─────────────┼────────────┼───┼───┼───┼──────┤
//    │ OSM(lsft) │ a │ s │ d │      f      │  g  │                                          │      h      │     j      │ k │ l │ ; │  '   │
//    ├───────────┼───┼───┼───┼─────────────┼─────┤                                          ├─────────────┼────────────┼───┼───┼───┼──────┤
//    │ OSM(lctl) │ y │ x │ c │      v      │  b  │                                          │      n      │     m      │ , │ . │ - │ esc  │
//    └───────────┴───┴───┴───┼─────────────┼─────┼──────────────────┐   ┌───────────────────┼─────────────┼────────────┼───┴───┴───┴──────┘
//                            │ LGUI_T(esc) │ spc │ LT(LAYER_1, tab) │   │ LT(LAYER_2, bspc) │ RSFT_T(ent) │ rght_SHIFT │
//                            └─────────────┴─────┴──────────────────┘   └───────────────────┴─────────────┴────────────┘
[LAYER_BASE] = LAYOUT_split_3x6_3(
  KC_TAB        , KC_Q , KC_W , KC_E , KC_R           , KC_T   ,                                                  DE_Z           , KC_U           , KC_I    , KC_O   , KC_P    , KC_BSPC,
  OSM(MOD_LSFT) , KC_A , KC_S , KC_D , KC_F           , KC_G   ,                                                  KC_H           , KC_J           , KC_K    , KC_L   , DE_SCLN , DE_QUOT,
  OSM(MOD_LCTL) , DE_Y , KC_X , KC_C , KC_V           , KC_B   ,                                                  KC_N           , KC_M           , KC_COMM , DE_DOT , DE_MINS , KC_ESC ,
                                       LGUI_T(KC_ESC) , KC_SPC , LT(LAYER_1, KC_TAB) ,     LT(LAYER_2, KC_BSPC) , RSFT_T(KC_ENT) , KC_RIGHT_SHIFT
),
...
//    ├─────┼────┼────┼────┼─────┼─────┤               ├───────────────────┼──────┼──────┼──────┼──────┼────┤
//    │     │ ä  │ ß  │ no │ no  │ no  │               │       left        │ down │  up  │ rght │  ö   │ ä  │
//    ├─────┼────┼────┼────┼─────┼─────┤               ├───────────────────┼──────┼──────┼──────┼──────┼────┤
//    │     │ no │ no │ no │ no  │ no  │               │       vold        │ volu │ mprv │ mnxt │ mply │ no │
//    └─────┴────┴────┴────┼─────┼─────┼─────┐   ┌─────┼───────────────────┼──────┼──────┴──────┴──────┴────┘
//                         │     │     │     │   │     │ MO(LAYER_OPTIONS) │      │
//                         └─────┴─────┴─────┘   └─────┴───────────────────┴──────┘
[LAYER_1] = LAYOUT_split_3x6_3(
  KC_TRNS , KC_1    , KC_2    , KC_3    , KC_4    , KC_5    ,                         KC_6              , KC_7    , KC_8    , KC_9     , KC_0    , DE_UDIA,
  KC_TRNS , DE_ADIA , DE_SS   , XXXXXXX , XXXXXXX , XXXXXXX ,                         KC_LEFT           , KC_DOWN , KC_UP   , KC_RIGHT , DE_ODIA , DE_ADIA,
  KC_TRNS , XXXXXXX , XXXXXXX , XXXXXXX , XXXXXXX , XXXXXXX ,                         KC_VOLD           , KC_VOLU , KC_MPRV , KC_MNXT  , KC_MPLY , XXXXXXX,
